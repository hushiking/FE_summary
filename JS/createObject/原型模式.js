...
console.log('1:', person2.hasOwnProperty('name'))
console.log('2:', 'name' in person2)
console.log('3:', hasPrototypeProperty(person2, 'name'))
delete person2.name
person2.sayName()
console.log('4:', person2.hasOwnProperty('name'))
console.log('5:', 'name' in person2)
console.log('6:', hasPrototypeProperty(person2, 'name'))

console.log('实例对象共享原型方法：', person1.sayName === person2.sayName)

// Object.keys返回对象自身的可枚举属性
person1.name = 'cuqi'
console.log('person1:', Object.keys(person1))
console.log('person2:', Object.keys(person2))
console.log('prototype:', Object.keys(person1.__proto__))
...
console.log('实例1:', friend instanceof Object)
console.log('实例2:', friend instanceof Person)
console.log('构造函数1:', friend.constructor === Person)
console.log('构造函数2:', friend.constructor)
console.log('构造函数3:', friend.constructor === Object)
...
console.log('构造函数4:', people.constructor === Person)
console.log('构造函数5:', '构造函数:', people.constructor)
console.log('构造函数6:', people.constructor === Object)
